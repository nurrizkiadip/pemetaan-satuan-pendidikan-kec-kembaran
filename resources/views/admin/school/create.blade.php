              ...
              <div class="form-group">
                ...
                >
                  ...
                  @foreach($schoolLevels as $item)
                    <option
                        {{ (int)old('school_level_id') === $item->id ? 'selected' : '' }}
                        value="{{ $item->id }}">
                      {{ $item->name }}
                    </option>
                  @endforeach
          ...
          <div class="row">
            <div class="col-md-6 col-12">
              <div class="form-group">
                ...
                <input type="text" value="{{ old('lat') }}" class="form-control" readonly name="lat" id="lat">
                @error('lat')
                <div class="invalid-feedback text-danger d-block">
                  {{ $message }}
                </div>
            ...
            <div class="col-md-6 col-12">
              <div class="form-group">
                ...
                <input type="text" value="{{ old('lang') }}" class="form-control" readonly name="lang" id="lang">
              </div>
              @error('lang')
              <div class="invalid-feedback text-danger d-block">
                {{ $message }}
