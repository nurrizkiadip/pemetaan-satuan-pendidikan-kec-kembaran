...
@section('title', "Edit Jenjang Sekolah $schoolLevel->name")
    ...
    <div class="row mb-2">
      <div class="col">
        <ol class="text-sm breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active">Edit Jenjang Sekolah {{ $schoolLevel->name }}</li>
        </ol>
      </div>
    </div>
    <div class="row mb-2">
      <div class="col">
        <h1 class="m-0">Edit Jenjang Sekolah {{ $schoolLevel->name }}</h1>
      </div>
    </div>
  </div>
@endsection
	...
	<div class="container-fluid">
		<div class="row">
			<section class="col-xl-6 col-md-8 col-sm-10 col-12">
				<form action="{{ route('admin.school-level.update', [$schoolLevel->id]) }}"
